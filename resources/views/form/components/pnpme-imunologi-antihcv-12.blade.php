        ...
        <tr>
            ...
            <td>
                <div class="input-group date">
                    ...
                    <input placeholder="Tanggal Kadaluarsa" name="tanggal_kadaluarsa" class="form-control pull-right" id="tanggal_kadaluarsa_input" type="date" value="{{ $f->tanggal_kadaluarsa ?? '' }}">
                </div>
            </td>
        </tr>
        </tbody>
