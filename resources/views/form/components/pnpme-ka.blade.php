@php
    ...
    $package = \App\v3\Package::query()->where('name', '=', 'pnpme-ka-3')->get()->first();
...
<form id="submit-form" class="ui form" method="post" action="{{ $route }}">
    ...
    <div class="ui two fields">
        ...
        <div class="ui field">
            <label>{{ 'Deskripsi Kondisi Kemasan Luar' }}</label>
            <input placeholder="Deskripsi kondisi kemasan luar" type="text" class="form-control" name="{{ 'deskripsi_kondisi_kemasan_luar' }}" value="{{ $f->deskripsi_kondisi_kemasan_luar ?? '' }}">
        </div>
    ...
    <div class="ui two fields">
        ...
        <div class="ui field">
            <label>{{ 'Deskripsi Kondisi Bahan Uji' }}</label>
            <input placeholder="Deskripsi kondisi bahan uji" type="text" class="form-control" name="{{ 'deskripsi_kondisi_bahan_uji' }}" value="{{ $f->deskripsi_kondisi_bahan_uji ?? '' }}">
        </div>
    ...
    <table class="ui table">
        ...
        <tr>
            ...
            <th width="20%" class="center aligned">Hasil Pengujian</th>

            <th width="20%" class="center aligned"><i>U* <small>Ketidakpastian</small></i></th>

            <th width="20%" class="center aligned">Satuan</th>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <input placeholder="Hasil Pengujian" name="{{ 'hasil_pengujian_' . $parameter->label }}" value="{{ $f->{'hasil_pengujian_'  . $parameter->label} ?? '' }}" type="text" class="form-control">
                    </div>
                </td>

                <td>
                    <div class="form-group">
                        <input placeholder="U*" type="text" class="form-control" name="{{ 'ketidakpastian_' . $parameter->label }}" value="{{ $f->{'ketidakpastian_' . $parameter->label} ?? '' }}">
                    </div>
                </td>

                <td>
                    <div class="form-group">
                        <input placeholder="Satuan" type="text" class="form-control" name="{{ 'satuan_' . $parameter->label }}" value="{{ $f->{'satuan_' . $parameter->label} ?? '' }}">
                    </div>
                </td>

                <td>
                    <div class="form-group">
                        <input placeholder="Metode" type="text" class="form-control" name="{{ 'metode_' . $parameter->label }}" value="{{ $f->{'metode_' . $parameter->label} ?? '' }}">
                    </div>
                </td>
