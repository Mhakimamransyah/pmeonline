            ...
            <tr>
                ...
                <td>
                    <div class="ui fluid right labeled input">
                        <input placeholder="Hasil Pengujian" name="{{ 'hasil_pengujian_' . $parameter->label }}" value="{{ $f->{'hasil_pengujian_'  . $parameter->label} ?? '' }}" type="number" step="any" class="form-control">
                        <div class="ui label">
                            ppm
                        </div>
                    </div>
