...
@php
    ...
    $subject = \App\Subject::where('name', '=', $hematologi)->first();
                ...
                <table class="table table-bordered">
                    ...
                    @foreach($parameters as $key => $parameter)
                        <tr>
                            ...
                            <td>
                                @php
                                    $methods = \App\Method::where('parameter_id', '=', $parameter->id)->get();
                            ...
                            <td>
                                {{ $f->{ 'hasil_' . $key . '_bottle_' . $bottle } or '' }}
                            </td>
                        </tr>
                    @endforeach
