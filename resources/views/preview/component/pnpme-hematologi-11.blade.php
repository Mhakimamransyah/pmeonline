@php
    ...
    $packageInjectData = \App\Package::query()->where('name', 'pnpme-hematologi-3')->get()->first();
...
@for($bottle = 1; $bottle <= 2; $bottle++)
    ...
    <table class="ui table celled">
        ...
        <tr>
            ...
            <th style="width: 15%" class="center aligned">{{ 'Parameter' }}</th>

            <th style="width: 17%" class="center aligned">{{ 'Metode' }}</th>

            <th style="width: 17%" class="center aligned">{{ 'Alat' }}</th>

            <th style="width: 17%" class="center aligned">{{ 'Kualifikasi Pemeriksa' }}</th>

            <th style="width: 17%" class="center aligned">{{ 'Hasil Pengujian' }}</th>
