@php
    ...
    $kultur1_items = ['Gentacimin', 'Levofloxacine', 'Amikacin', 'Ciprofloxacine', 'Co-trimoxazole'];
    $kultur2_items = ['Ampicilline', 'Ciprifloxacine', 'Co-trimoxazole', 'Tetracyclin', 'Cefazolin'];
...
<h4 class="ui divider header horizontal">Hasil Uji Kepekaan Kultur 3</h4>
