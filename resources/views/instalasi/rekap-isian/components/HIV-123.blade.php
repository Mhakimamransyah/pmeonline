            ...
            <div style="overflow-x: scroll;">
                ...
                <table class="ui table celled structured" style="min-width: 1366px;">
                    ...
                    <tr>
                        ...
                        <th rowspan="2" width="25%" class="center aligned">Saran</th>
                        <th rowspan="2" width="25%" class="center aligned">Keterangan</th>
                    </tr>
                    </thead>
                    <tbody>
                    @php
                        ...
                        @for($panel = 0; $panel < 3; $panel++)
                            @for($test = 0; $test < 3; $test++)
                                <tr>
                                    ...
                                    @if ($panel == 0 && $test == 0)
                                        <td rowspan="10" class="center aligned">{{ $submitValue->saran ?? '-' }}</td>
                                        <td rowspan="10" class="center aligned">{{ $submitValue->keterangan ?? '-' }}</td>
                                    @endif
                                </tr>
                            @endfor
                        @endfor
