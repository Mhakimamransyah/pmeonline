                        ...
                        @for($panel = 0; $panel < 3; $panel++)
                            @for($test = 0; $test < 3; $test++)
                                <tr>
                                    ...
                                    @if($scoreValue != null)
                                        @php
                                            $selected = $daftar_pilihan_interpretasi_hasil->where('value', '=', $scoreValue->{'rujukan'}[$panel][$test])->first();
                                        @endphp
                                        @if ($selected != null)
                                            <td class="center aligned">
                                                {{ $selected->text }}
                                        ...
                                        @php
                                            $selected = $scoreValue->{'hasil'}[$panel][$test];
                                            if ($test == 0) {
                                                $sum = 0;
                                                $count = 0;
                                            }
