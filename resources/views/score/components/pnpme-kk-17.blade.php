        ...
        <table class="table table-bordered">
            ...
            @foreach($submit->order->package->parameters as $parameter)
                <tr>
                    ...
                    @if($f->{'hasil_'.($parameter_count - 1).'_'.$bottle} != null)
                        @php
                            $method = $f->{'metode_pemeriksaan_'.($parameter_count - 1).'_'.$bottle} ?? '99';
                            $equipment = $f->{'alat_'.($parameter_count - 1).'_'.$bottle} ?? '99';
                            $hasil = $f->{'hasil_'.($parameter_count - 1).'_'.$bottle};
                        @endphp
                        ...
                        @php
                            ...
                            $sdpa = $bottleResult->byParameters->resultByQuartile;
                        ...
                        @php
                            ...
                            if ($byMethodResult != null) {
                                $sdpa = $byMethodResult->second->resultByQuartile;
                        ...
                        @php
                            ...
                            if ($byEquipmentResult != null) {
                                $sdpa = $byEquipmentResult->second->resultByQuartile;
