    ...
    <div class="medium-form hide-on-loading">
        ...
        <div class="medium-form-content">
            ...
            <div class="ui breadcrumb">
                ...
                <i class="right arrow icon divider"></i>
                <div class="active section">{{ __('Daftar Peserta') }}</div>
            </div>
...
@section('script')
    ...
    <script>
        let dataSourceUrl = '{{ route('administrator.cycle.participant.data', ['cycleId' => $cycle->getId()]) }}';
        let cycleId = '{{ $cycle->getId() }}';
        let listType = 'participant';
    </script>
